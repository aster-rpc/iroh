...
| `iroh-blobs` | `v0.103.0` | `aster-iroh-blobs-v0.103.0-p2` | `1f01a0878384b4c0fab343319e88fb1acb7bb27b` | `upgrade/iroh-blobs-v0.103` |
...
- iroh stack carried: noq fork `[patch.crates-io]` entries (pinned to
  ...
  fmt fixups.
- `iroh-blobs` gained two post-tag commits on 2026-08-13 (functional patch row 8
  below): downloader progress observability plus its monotonicity follow-up,
  retagged `aster-iroh-blobs-v0.103.0-p2`. Canonical source branch is
...
git -C /Users/emrul/dev/aster/iroh-blobs  switch --detach aster-iroh-blobs-v0.103.0-p2
